...
require_once $conf->root_path.'/app/calc/CalcResultCredit.class.php';
require_once $conf->root_path.'/app/calc/CalcResultSum.class.php';
...
class CalcControl {
	...
	public function generateView(){
        ...
        $smarty->assign('page_description','Kontroler - jeden "punkt wejścia" ');
        $smarty->assign('page_header','Kontroler');
