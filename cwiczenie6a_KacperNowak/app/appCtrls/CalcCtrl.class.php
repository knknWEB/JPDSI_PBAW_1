...
require_once 'CalcResultCredit.class.php';
require_once 'CalcResultSum.class.php';
...
class CalcControl {
	...
	public function generateView(){
        ...
        getSmarty()->assign('page_header','Kontroler - Ćwiczenie 06a');		
		getSmarty()->assign('page_description','Kontroler - jeden punkt wejścia');
